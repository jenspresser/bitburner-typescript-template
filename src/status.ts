...
import { BackdooredServersStatusProperty, GangMemberStatusProperty, GangPowerStatusProperty, GangTerritoryStatusProperty, HacknetHashToMoneyModeStatusProperty, HacknetPurchaseModeStatusProperty, HomeRamStatusProperty, KarmaStatusProperty, ProgramCountStatusProperty, PservCountStatusProperty, RootServersStatusProperty, ScriptGainExperienceStatusProperty, ScriptGainMoneyStatusProperty, TargetModeStatusProperty } from "./properties";
...
const PROPERTIES: StatusProperty[] = [
    ...
    HacknetPurchaseModeStatusProperty.INSTANCE,
    HacknetHashToMoneyModeStatusProperty.INSTANCE,
